...
const PhysioLanding = () => {
  ...
  return (
    <div className={`font-sans text-slate-600 antialiased bg-[#fcfbf9] selection:bg-[#047857] selection:text-white scroll-smooth`}>
        ...
        <div className="container mx-auto px-4 md:px-6 h-16 md:h-20 flex justify-between items-center">
          ...
          <a href="#" className="flex items-center gap-2 md:gap-3 group">
            ...
            <div>
              ...
              <span className="hidden md:block text-[10px] text-[#d97706] font-bold tracking-[0.2em] uppercase">Physiotherapy</span>
            </div>
          </a>
              ...
              <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-20 pt-10">
                <div className="max-w-2xl">
                  ...
                  <p className="text-base md:text-xl text-slate-200 mb-8 md:mb-10 max-w-lg font-light leading-relaxed opacity-90">
                    Expert physiotherapy specializing in sports recovery and chronic pain management. Reclaim your active life today.
                  </p>
              ...
              <div className="bg-[#047857]/95 backdrop-blur-xl text-white p-6 rounded-2xl shadow-[0_0_25px_-5px_rgba(4,120,87,0.25)] hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-50 leading-relaxed">15+ Years Experience.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full lg:w-1/2">
              <Reveal delay={200}>
                ...
                <h2 className="text-4xl md:text-5xl font-serif font-bold text-slate-900 mb-6 md:mb-8 leading-tight">
                  "I don't just treat symptoms. <br />I build <span className="text-[#047857] italic">resilience</span>."
                </h2>
                <p className="text-lg text-slate-600 mb-10 leading-relaxed font-light">
                  Combining advanced manual therapy with biomechanical analysis, I help you understand your body's language. My goal isn't just to fix the pain, but to prevent it from returning.
                </p>
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-3 py-1.5 md:px-4 md:py-2 bg-slate-50 rounded-full text-[10px] md:text-xs font-bold text-slate-600 border border-slate-200">MSc. Physiotherapy</span>
                  <span className="px-3 py-1.5 md:px-4 md:py-2 bg-slate-50 rounded-full text-[10px] md:text-xs font-bold text-slate-600 border border-slate-200">OMPT Certified</span>
                  <span className="px-3 py-1.5 md:px-4 md:py-2 bg-slate-50 rounded-full text-[10px] md:text-xs font-bold text-slate-600 border border-slate-200">Dry Needling</span>
                </div>
              </Reveal>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Reveal>
              <div className="group bg-white p-8 rounded-4xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 relative overflow-hidden h-full">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-[#047857] transition">Shockwave Therapy</h3>
                <p className="text-slate-500 mb-6 leading-relaxed text-sm">Non-invasive acoustic waves to treat chronic tendon pain and calcifications effectively.</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={100}>
              <div className="group bg-white p-8 rounded-4xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 relative overflow-hidden h-full">
                ...
                <p className="text-slate-500 mb-6 leading-relaxed text-sm">Hands-on mobilization to restore joint movement and reduce muscle tension.</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={200}>
              <div className="group bg-white p-8 rounded-4xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 relative overflow-hidden h-full">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-[#047857] transition">Dry Needling</h3>
                <p className="text-slate-500 mb-6 leading-relaxed text-sm">Targeted release of trigger points to instantly relieve pain and improve range of motion.</p>
              </div>
            </Reveal>
          </div>
        </div>
      ...
      <a href="https://wa.me/15551234567?text=Hello%20Dr.%20Amarjeet%20Panghal,%20I%20would%20like%20to%20book%20an%20appointment." 
