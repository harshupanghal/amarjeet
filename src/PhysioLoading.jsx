...
const PhysioLanding = () => {
  ...
  return (
    <div className={`font-sans text-slate-600 antialiased bg-[#fcfbf9] selection:bg-[#047857] selection:text-white scroll-smooth`}>
      ...
      <header className="sticky top-0 z-40 bg-white/85 backdrop-blur-xl border-b border-white/50 shadow-sm transition-all duration-300">
        <div className="container mx-auto px-4 md:px-6 h-16 md:h-20 flex justify-between items-center">
          ...
          <a href="#" className="flex items-center gap-2 md:gap-3 group">
            ...
            <div>
              <span className="block text-base md:text-lg font-serif font-bold text-slate-900 leading-none">Dr. Amarjeet Panghal</span>
              <span className="hidden md:block text-[10px] text-[#d97706] font-bold tracking-[0.2em] uppercase">Physiotherapist</span>
            </div>
          </a>
          ...
          <nav className="hidden md:flex items-center gap-8 text-xs font-bold tracking-widest uppercase text-slate-500">
            ...
            <a href="#services" className="hover:text-[#047857] transition-colors">Services</a>
            <a href="#stories" className="hover:text-[#047857] transition-colors">Stories</a>
            <a href="#contact" className="bg-[#047857] text-white px-6 py-3 rounded-full shadow-[0_0_25px_-5px_rgba(4,120,87,0.25)] hover:bg-[#0f172a] hover:shadow-lg transition-all transform hover:-translate-y-0.5">
              Book Appointment
            </a>
          </nav>
          ...
          {/* Mobile Hamburger */}
          <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="md:hidden p-2 text-slate-800 focus:outline-none">
            {mobileMenuOpen ? (
        ...
        {/* Mobile Menu */}
        <div className={`md:hidden bg-white border-t p-4 space-y-4 shadow-xl border-b border-slate-100 overflow-hidden transition-all duration-300 ease-in-out ${mobileMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
          <a href="#about" onClick={() => setMobileMenuOpen(false)} className="block font-bold text-slate-700 py-2">About</a>
          <a href="#services" onClick={() => setMobileMenuOpen(false)} className="block font-bold text-slate-700 py-2">Services</a>
          <a href="#stories" onClick={() => setMobileMenuOpen(false)} className="block font-bold text-slate-700 py-2">Success Stories</a>
          <a href="#contact" onClick={() => setMobileMenuOpen(false)} className="block w-full text-center bg-[#047857] text-white py-3 rounded-xl font-bold">Book Now</a>
        </div>
      </header>
            ...
            <div className="relative h-150 md:h-175 w-full rounded-4xl overflow-hidden shadow-2xl group bg-slate-900">
              ...
              <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
                <img 
                  ...
                  alt="Physiotherapy Hero Background"
...
{/*                   
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mt-2">
                    <a href="#contact" className="bg-[#d97706] text-white px-8 py-4 rounded-full font-bold shadow-lg hover:bg-white hover:text-[#d97706] transition-all flex items-center justify-center gap-2 group w-full sm:w-auto">
                      Start Recovery
                      <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                    </a>
                    <a href="#gallery" className="px-8 py-4 rounded-full font-bold text-white border border-white/30 hover:bg-white/10 transition backdrop-blur-sm flex items-center justify-center gap-2 w-full sm:w-auto">
                      Watch Video
                    </a>
                  </div>
                </div>
            ...
            <div className="relative -mt-16 z-20 grid grid-cols-1 md:grid-cols-3 gap-4 px-2 md:px-12">
              <div className="bg-white/95 backdrop-blur-xl p-6 rounded-2xl shadow-[0_10px_30px_-10px_rgba(0,0,0,0.08)] hover:shadow-2xl transition-all duration-300 border border-white/50 hover:-translate-y-2 group">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-serif font-bold text-slate-900 mb-1">24h Access</h3>
                    <p className="text-sm text-slate-500 leading-relaxed">Priority slots for acute pain.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#047857]/95 backdrop-blur-xl text-white p-6 rounded-2xl shadow-[0_0_25px_-5px_rgba(4,120,87,0.25)] hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-serif font-bold mb-1">Master Class</h3>
                    <p className="text-sm text-green-50 leading-relaxed">8+ Years Experience.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/95 backdrop-blur-xl p-6 rounded-2xl shadow-[0_10px_30px_-10px_rgba(0,0,0,0.08)] hover:shadow-2xl transition-all duration-300 border border-white/50 hover:-translate-y-2 group">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-serif font-bold text-slate-900 mb-1">Private Suites</h3>
                    <p className="text-sm text-slate-500 leading-relaxed">1-on-1 dedicated sessions.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
            ...
            <div className="w-full lg:w-1/2">
              <Reveal delay={200}>
                <h4 className="text-[#d97706] font-bold uppercase tracking-widest mb-4 text-xs">Meet Dr. Amarjeet Panghal</h4>
                <h2 className="text-4xl md:text-5xl font-serif font-bold text-slate-900 mb-6 md:mb-8 leading-tight">
                  "Restoring motion <br /> <span className="text-[#047857] italic">Uplifting spirits</span>."
                </h2>

                <p className="text-lg text-slate-600 mb-5 leading-relaxed font-light">
                  Expert physiotherapist dedicated to restoring mobility and dignity for the elderly. Specializing in post-surgery rehabilitation, neuro-physiotherapy, and cervical care, I offer a holistic approach that blends rigorous physical therapy with essential psychological support. With a track record of 100% treatment success, I am committed to helping senior patients recover their strength and live pain-free lives.
                </p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-12 border-t border-b border-slate-100 py-8">
                  <div className="text-center md:text-left">
                    ...
                    <div className="text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-widest">Years Exp.</div>
                  </div>
                  <div className="text-center md:text-left">
                    <div className="text-3xl md:text-4xl font-serif font-bold text-[#0f172a] mb-1 flex items-center justify-center md:justify-start">
                      <Counter end={1000} />+
                  ...
                  <div className="text-center md:text-left col-span-2 md:col-span-1">
                    ...
                    <div className="text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-widest">Commitment</div>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-3 py-1.5 md:px-4 md:py-2 bg-slate-50 rounded-full text-[10px] md:text-xs font-bold text-slate-600 border border-slate-200">M.D. (A.M.)</span>
                  <span className="px-3 py-1.5 md:px-4 md:py-2 bg-slate-50 rounded-full text-[10px] md:text-xs font-bold text-slate-600 border border-slate-200">BPT</span>
                  <span className="px-3 py-1.5 md:px-4 md:py-2 bg-slate-50 rounded-full text-[10px] md:text-xs font-bold text-slate-600 border border-slate-200">Acupressure</span>
                   <span className="px-3 py-1.5 md:px-4 md:py-2 bg-slate-50 rounded-full text-[10px] md:text-xs font-bold text-slate-600 border border-slate-200">Master in Naturopathy and Yoga</span>
                </div>
              </Reveal>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <Reveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              <span className="text-[#047857] font-bold uppercase tracking-widest text-xs bg-[#d1fae5]/50 px-3 py-1 rounded-full">Our Expertise</span>
              <h2 className="text-3xl md:text-5xl font-serif font-bold text-slate-900 mt-4 mb-6">Clinical Precision. <br />Holistic Care.</h2>
            </div>
          </Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Reveal>
              <div className="group bg-white p-8 rounded-4xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 relative overflow-hidden h-full">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-[#047857] transition">Cervical Expertise</h3>
                <p className="text-slate-500 mb-6 leading-relaxed text-sm">Applying advanced cervical techniques, we resolve complex nerve compression and structural misalignments to restore total neck mobility and neurological health.</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={100}>
              <div className="group bg-white p-8 rounded-4xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 relative overflow-hidden h-full">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-[#047857] transition">Manual Therapy</h3>
                <p className="text-slate-500 mb-6 leading-relaxed text-sm">With skilled hands, we apply precise joint and soft-tissue techniques to dissolve muscle tension and restore your body’s natural range of motion.</p>
              </div>
            </Reveal>
  ...
  {/* Service 2 */}
            <Reveal delay={100}>
              <div className="group bg-white p-8 rounded-4xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 relative overflow-hidden h-full">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-[#047857] transition">Senior Mobility Support</h3>
                <p className="text-slate-500 mb-6 leading-relaxed text-sm">Restoring Strength. Reclaiming Confidence. With expert guidance, we build physical stability and ease the fear of falling, returning you to a safe and independent life.</p>
              </div>
            </Reveal>
              ...
              <div className="group bg-white p-8 rounded-4xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 relative overflow-hidden h-full">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-[#047857] transition">Neuro Recovery </h3>
                <p className="text-slate-500 mb-6 leading-relaxed text-sm">Restoring Control. Through clinical mastery, we stimulate neurological pathways to improve motor function and help you reclaim command over your body.</p>
              </div>
            </Reveal>
              ...
              <div className="group bg-white p-8 rounded-4xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 relative overflow-hidden h-full">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-[#047857] transition">Acupressure Targeted Relief</h3>
                <p className="text-slate-500 mb-6 leading-relaxed text-sm">Applying precise pressure, we stimulate vital points to release deep-seated tension, alleviate pain, and restore your body’s natural energy flow.</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={200}>
              <div className="group bg-white p-8 rounded-4xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 relative overflow-hidden h-full">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-[#047857] transition">Post-Surgery Recovery</h3>
                <p className="text-slate-500 mb-6 leading-relaxed text-sm">Our expert approach bridges the gap between surgery and daily life, ensuring a full and functional recovery.</p>
              </div>
            </Reveal>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <Reveal>
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-900 mb-4">Treatment <span className="text-[#d97706]">Gallery</span></h2>
              <p className="text-slate-500">State-of-the-art facilities designed for your comfort.</p>
            </div>
          </Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4 h-200 md:h-150">
            ...
            <div className="md:col-span-2 md:row-span-2 relative rounded-3xl overflow-hidden shadow-lg border border-slate-100">
              <Reveal className="h-full">
                <YouTubeFacade 
                  videoId="1f8yoFFdkcY" 
                  poster="https://images.unsplash.com/photo-1579126038374-6064e9370f0f?auto=format&fit=crop&q=80"
                  title="Facility Tour"
                />
              </Reveal>
            </div>
            ...
            {/* Photos */}
            <div className="relative rounded-3xl overflow-hidden shadow-lg group cursor-zoom-in" 
                 onClick={() => openLightbox('https://images.unsplash.com/photo-1516062423079-7ca13cdc7f5a?auto=format&fit=crop&q=80')}>
              <Reveal delay={100} className="h-full">
                <img src="https://images.unsplash.com/photo-1516062423079-7ca13cdc7f5a?auto=format&fit=crop&q=80" loading="lazy" alt="Therapy Session" className="w-full h-full object-cover transition duration-700 group-hover:scale-110" />
              </Reveal>
            </div>


            <div className="relative rounded-3xl overflow-hidden shadow-lg group cursor-zoom-in"
                 onClick={() => openLightbox('https://images.unsplash.com/photo-1666214280557-f1b5022eb634?auto=format&fit=crop&q=80')}>
              <Reveal delay={200} className="h-full">
                <img src="https://images.unsplash.com/photo-1666214280557-f1b5022eb634?auto=format&fit=crop&q=80" loading="lazy" alt="Equipment" className="w-full h-full object-cover transition duration-700 group-hover:scale-110" />
              </Reveal>
            </div>


            <div className="md:col-span-2 relative rounded-3xl overflow-hidden shadow-lg group cursor-zoom-in"
                 onClick={() => openLightbox('https://images.unsplash.com/photo-1597452485669-2c7bb5fef90d?auto=format&fit=crop&q=80')}>
              <Reveal delay={300} className="h-full">
                <img src="https://images.unsplash.com/photo-1597452485669-2c7bb5fef90d?auto=format&fit=crop&q=80" loading="lazy" alt="Massage" className="w-full h-full object-cover transition duration-700 group-hover:scale-110" />
              </Reveal>
            </div>
          </div>
        </div>
      ...
      {/* 6. TESTIMONIALS */}
      <section id="stories" className="py-24 bg-[#fcfbf9] relative">
        <div className="container mx-auto px-6">
          <Reveal>
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-900 mb-4">Patient <span className="text-[#d97706]">Stories</span></h2>
              <p className="text-slate-500">Real recovery journeys.</p>
            </div>
          </Reveal>
            ...
            <Reveal delay={100}>
             ...
             <Reveal delay={200}>
                <div className="bg-white p-8 rounded-4xl shadow-[0_10px_30px_-10px_rgba(0,0,0,0.08)] relative h-full">
                  ...
                  <div className="flex items-center gap-3">
                    <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Emma W." className="w-10 h-10 rounded-full" />
                    <div>
                      <div className="font-bold text-slate-900 text-sm">Emma W.</div>
                      <div className="text-[#d97706] text-xs">★★★★★</div>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="bg-white/5 backdrop-blur-lg rounded-[2.5rem] border border-white/10 p-8 md:p-16 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
              <Reveal>
                <div>
                  <h2 className="text-4xl md:text-6xl font-serif font-bold mb-6">Start your <br />recovery.</h2>
                  <p className="text-slate-400 text-lg mb-10">We accept major insurance plans. <br />Book online or call us directly.</p>
                  ...
                  <div className="flex items-center gap-6 mb-4">
                      ...
                      <div className="text-2xl font-serif font-bold">+91 981 212 6760</div>
                  </div>
                </div>
              </Reveal>
              ...
              <Reveal delay={100}>
                <form className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <input type="text" placeholder="Name" className="w-full bg-white/10 border border-white/10 rounded-xl px-6 py-4 placeholder-slate-400 focus:bg-white/20 focus:outline-none transition" />
                    <input type="text" placeholder="Phone" className="w-full bg-white/10 border border-white/10 rounded-xl px-6 py-4 placeholder-slate-400 focus:bg-white/20 focus:outline-none transition" />
                  </div>
                  ...
                  <button className="w-full bg-white text-[#0f172a] font-bold text-lg py-4 rounded-xl hover:bg-[#d97706] hover:text-white transition shadow-lg">Request Appointment</button>
                </form>
              </Reveal>
            </div>
          </div>
      ...
      <a href="https://wa.me/9812126760?text=Hello%20Dr.%20Amarjeet%20Panghal,%20I%20would%20like%20to%20book%20an%20appointment." 
         className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-lg hover:scale-110 transition-transform flex items-center gap-2 group">
          ...
          <span className="max-w-0 overflow-hidden group-hover:max-w-xs transition-all duration-500 whitespace-nowrap text-sm font-bold">Chat with Dr. Amarjeet</span>
      </a>


      {/* Footer */}
      <footer className="bg-[#0f172a] border-t border-white/5 py-12 text-center text-slate-500 text-sm">
        <p>&copy; 2025 Dr. Amarjeet Panghal Physiotherapy. All rights reserved.</p>
      </footer>
